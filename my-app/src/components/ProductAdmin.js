...
export default class ProductAdmin extends Component {
  ...
  handleAddProduct = async (id, event) => {
    ...
    try {
      ...
      await axios.post(`${API_CONFIG.endpoints.products}/${id}`, params);
  ...
  handleUpdateProduct = async (id, name) => {
    ...
    try {
      ...
      await axios.patch(`${API_CONFIG.endpoints.products}/${id}`, params);
  ...
  handleDeleteProduct = async (id, event) => {
    ...
    try {
      await axios.delete(`${API_CONFIG.endpoints.products}/${id}`);
      const updatedProducts = [...this.state.products].filter(product => product.id !== id);
      this.setState({products: updatedProducts});
    }catch (err) {
  ...
  fetchProducts = async () => {
    ...
    try {
      const res = await axios.get(API_CONFIG.endpoints.products);
